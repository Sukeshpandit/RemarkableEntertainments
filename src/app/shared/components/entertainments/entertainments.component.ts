...
import { SHOWCASE_CARDS, ShowcaseCard } from '../experiences-cards/experiences-card.data';
...
export class EntertainmentsComponent implements AfterViewInit, OnDestroy {
